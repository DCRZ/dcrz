...
{ // Lair (OOD cap: 12)
  {  1,  4, 5500, FLAT, MONS_NO_MONSTER }, // Roughly old D:1-4 chaff weight
  { -1,  4,   52, SEMI, MONS_BLACK_BEAR },
  { -1,  5,  260, SEMI, MONS_BASILISK },
  { -1,  9,  440, SEMI, MONS_HYDRA },
  {  0,  3,   24, PEAK, MONS_SCORPION },
  {  0,  4,  260, SEMI, MONS_WOLF },
  {  0,  7,  240, PEAK, MONS_RIME_DRAKE },
  {  0,  9,  380, SEMI, MONS_BLACK_MAMBA },
  {  1,  4, 1000, FLAT, MONS_PORCUPINE },
  {  1,  4, 1000, FLAT, MONS_BULLFROG },
  {  1,  4,  990, FLAT, MONS_CROCODILE },
  {  1,  4,  990, FLAT, MONS_WATER_MOCCASIN },
  {  1,  4,  515, FLAT, MONS_HIPPOGRIFF },
  {  1,  4,  515, FLAT, MONS_YAK },
  {  1,  5,  188, PEAK, MONS_WYVERN },
  {  1,  6,  380, SEMI, MONS_BLINK_FROG },
  {  1,  4,  900, FLAT, MONS_CANE_TOAD },
  {  5,  8,  160, FLAT, MONS_CANE_TOAD },
  {  1,  4,  515, FLAT, MONS_KOMODO_DRAGON },
  {  5,  8,  160, FLAT, MONS_KOMODO_DRAGON },
  {  2,  4,    8, PEAK, MONS_HORNET },
  {  2,  4,   25, PEAK, MONS_STEAM_DRAGON },
  {  2,  5,   25, PEAK, MONS_OKLOB_PLANT },
  {  2,  6,   25, PEAK, MONS_HELL_RAT },
  {  2,  6,  100, SEMI, MONS_POLAR_BEAR },
  {  2,  7,  240, PEAK, MONS_ELEPHANT },
  {  2,  8,  160, RISE, MONS_DEATH_YAK },
  {  2,  9,   44, SEMI, MONS_CATOBLEPAS },
  {  2, 14,   60, SEMI, MONS_TORPOR_SNAIL },
  {  2,  6,   52, SEMI, MONS_POLAR_BEAR },
  {  2,  8,   25, PEAK, MONS_LINDWURM },
  {  3, 10,  140, SEMI, MONS_DREAM_SHEEP },
  {  3, 14,   36, RISE, MONS_FIRE_CRAB },
  {  9, 10,   32, FLAT, MONS_DIRE_ELEPHANT },
  {  9, 10,   32, FLAT, MONS_ALLIGATOR },
  {  9, 10,   32, FLAT, MONS_MANTICORE },
  {  9, 10,   32, FLAT, MONS_ANACONDA },
  {  9, 10,   32, FLAT, MONS_WOLF_SPIDER },
  { 0,0,0,FLAT,MONS_0 }
};
...
{ // Swamp
  ...
  // Easy enemies:
  {  0,  3,   500, FALL, MONS_VAMPIRE_MOSQUITO },
  {  0,  3,   500, FALL, MONS_SWAMP_DRAKE },
  {  0,  3,   500, FALL, MONS_SPRIGGAN_RIDER },
  {  0,  3,   500, FLAT, MONS_SPRIGGAN_RIDER },
  {  0,  3,   600, FALL, MONS_TYRANT_LEECH },
  {  0,  3,   500, FLAT, MONS_TYRANT_LEECH },
  {  0,  3,   700, FALL, MONS_GOLIATH_FROG  },
  {  0,  3,   500, FLAT, MONS_GOLIATH_FROG },
  {  0,  3,   300, FALL, MONS_BLOATED_HUSK },
  {  0,  3,   300, FLAT, MONS_BLOATED_HUSK },
  {  0,  3,   800, FALL, MONS_BOG_BODY },
  {  0,  3,   200, FLAT, MONS_BOG_BODY },
  // Harder enemies:
  {  0,  3,   400, FLAT, MONS_SPRIGGAN_DRUID },
  {  0,  3,   500, RISE, MONS_SPRIGGAN_DRUID },
  {  0,  3,   200, FLAT, MONS_GHOST_CRAB },
  {  0,  3,   300, RISE, MONS_GHOST_CRAB },
  {  0,  3,   500, FLAT, MONS_WILL_O_THE_WISP },
  {  0,  3,   400, RISE, MONS_WILL_O_THE_WISP },
  {  0,  3,   600, FLAT, MONS_ELEIONOMA },
  {  0,  3,   400, RISE, MONS_ELEIONOMA },
  {  0,  3,   800, FLAT, MONS_HYDRA },
  {  0,  3,   500, RISE, MONS_HYDRA },
  {  0,  3,   400, FLAT, MONS_SWAMP_DRAGON },
  {  0,  3,   600, RISE, MONS_SWAMP_DRAGON },
  {  0,  3,   600, FLAT, MONS_BUNYIP },
  {  0,  3,   400, RISE, MONS_BUNYIP },
  ...
  {  0,  3,    5, RISE, MONS_TENTACLED_MONSTROSITY },
  {  1,  4,   66, FLAT, MONS_SHAMBLING_MANGROVE },
  {  1,  4,  266, RISE, MONS_SHAMBLING_MANGROVE },
  // OODs
  {  4,  6, 1000, FLAT, MONS_FENSTRIDER_WITCH },
  {  4,  6, 3000, FLAT, MONS_SHAMBLING_MANGROVE },
  {  4,  6, 1500, FLAT, MONS_TENTACLED_MONSTROSITY },
  {  4,  6, 1500, FLAT, MONS_GHOUL },
  {  4,  6, 1000, FLAT, MONS_SPRIGGAN_AIR_MAGE },
  {  4,  6, 1000, FLAT, MONS_SPRIGGAN_BERSERKER },
  {  4,  6, 1000, FLAT, MONS_DEATH_DRAKE }, // not that bad but very mean
  { 0,0,0,FLAT,MONS_0 }
};
...
{ // Spider Nest
  { -2,  3,  260, RISE, MONS_HORNET },
  { -2,  8,  765, SEMI, MONS_DEMONIC_CRAWLER },
...
{ // Slime Pits
  ...
  {  1,  4, 1200, FALL, MONS_SLUDGE_DWARF_SLIME_PRIEST },
  {  1,  4,  900, FALL, MONS_DWARVEN_AUTOMATON },
...
{ // Crypt (OOD cap: 5)
  { -5,  1,   70, PEAK, MONS_SHADOW },
  { -5,  1,   40, PEAK, MONS_WIGHT },
  { -5,  1,   45, PEAK, MONS_FLYING_SKULL },
  { -5,  1,   75, SEMI, MONS_NECROMANCER },
  { -5,  1,   75, SEMI, MONS_DEATH_KNIGHT },
  { -4,  2,  125, SEMI, MONS_WRAITH },
  { -3,  3,   75, PEAK, MONS_JIANGSHI },
  { -3,  3,  125, PEAK, MONS_PHANTASMAL_WARRIOR },
  { -3,  7,  120, PEAK, MONS_ANCIENT_CHAMPION },
  {  -2,  1,   65, SEMI, MONS_FREEZING_WRAITH },
  {  -2,  3,  125, FLAT, MONS_VAMPIRE_MAGE },
  {  -2,  3,   93, PEAK, MONS_GHOUL },
  {  -2,  3,  105, FLAT, MONS_VAMPIRE_KNIGHT },
  {  -1,  2,   75, FLAT, MONS_SKELETAL_WARRIOR },
  {  -1,  3,   55, SEMI, MONS_SOUL_EATER },
  {  -1,  4,  145, SEMI, MONS_EIDOLON },
  {  -1,  4,   80, SEMI, MONS_DEEP_ELF_DEATH_MAGE },
  {  -1,  5,   85, SEMI, MONS_REVENANT },
  {  -1,  5,   75, SEMI, MONS_CURSE_SKULL },
  {  0,  3,  145, SEMI, MONS_FLAYED_GHOST },
  {  0,  3,   95, SEMI, MONS_SHADOW_WRAITH },
  {  0,  5,   40, SEMI, MONS_REAPER },
  {  0,  5,   55, PEAK, MONS_LICH },
  {  1,  5,   15, PEAK, MONS_ANCIENT_LICH },
  { 0,0,0,FLAT,MONS_0 }
};
