...
const Branch branches[NUM_BRANCHES] =
{
    ...
    { BRANCH_TOMB, BRANCH_CRYPT, 1, 1, 3, 21,
    ...
    { BRANCH_DIS, BRANCH_VESTIBULE, 1, 1, 5, 28,
      brflag::no_items | brflag::dangerous_end,
    ...
    { BRANCH_GEHENNA, BRANCH_VESTIBULE, 1, 1, 5, 28,
      brflag::no_items | brflag::dangerous_end,
    ...
    { BRANCH_COCYTUS, BRANCH_VESTIBULE, 1, 1, 5, 28,
      brflag::no_items | brflag::dangerous_end,
    ...
    { BRANCH_TARTARUS, BRANCH_VESTIBULE, 1, 1, 5, 28,
      brflag::no_items | brflag::dangerous_end,
    ...
    { BRANCH_ZOT, BRANCH_VAULTS, 5, 5, 5, 27,
      brflag::dangerous_end,
    ...
    { BRANCH_FOREST, BRANCH_LAIR, 3, 4, 5, 19,
      brflag::no_items | brflag::spotty | brflag::dangerous_end,
    ...
    { BRANCH_ZIGGURAT, BRANCH_VAULTS, 1, 4, 27, 27,
