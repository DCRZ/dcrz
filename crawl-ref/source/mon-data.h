...

{
    ...
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_TINY, MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    mrd(MR_RES_ACID, 3),
    10, MONS_DWARF, MONS_SLUDGE_DWARF, MH_NATURAL, 20,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 275,
    2, 12, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
{
    MONS_GELATINOUS_SNATCHER, 'w', LIGHTGREEN, "gelatinous snatcher",
    M_ACID_SPLASH | M_NO_EXP_GAIN | M_STATIONARY | M_NO_POLY_TO,
    MR_RES_POISON | mrd(MR_RES_ACID, 3),
    10, MONS_JELLY, MONS_GELATINOUS_SNATCHER, MH_NATURAL, 40,
    { {AT_CONSTRICT, AF_CRUSH, 0}, {AT_HIT, AF_ACID, 22}, AT_NO_ATK, AT_NO_ATK },
    14, 290,
...
{
    MONS_GELATINOUS_SNATCHER_SEGMENT, '*', LIGHTGREEN, "gelatinous snatcher segment",
    M_ACID_SPLASH | M_NOT_DANGEROUS | M_STATIONARY | M_NO_POLY_TO,
    MR_RES_POISON | mrd(MR_RES_ACID, 3),
    10, MONS_JELLY, MONS_GELATINOUS_SNATCHER, MH_NATURAL, 40,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 440,
...
{
    MONS_SASQUATCH, 'h', LIGHTGREEN, "the Sasquatch",
    M_WARM_BLOOD | M_SEE_INVIS | M_UNIQUE,
    MR_NO_FLAGS,
    15, MONS_SASQUATCH, MONS_SASQUATCH, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 25}, {AT_KICK, AF_PLAIN, 50}, AT_NO_ATK, AT_NO_ATK },
    18, 1650,
    12, 12, MST_SASQUATCH, true, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_BIG, MON_SHAPE_HUMANOID,
    {TILEP_MONS_SASQUATCH}, TILE_CORPSE_SASQUATCH
},
...
{
    MONS_ANCIENT_BEAR, 'h', RED, "ancient bear",
    M_WARM_BLOOD,
    MR_RES_FIRE,
    12, MONS_BEAR, MONS_ANCIENT_BEAR, MH_NATURAL, 20,
    { {AT_BITE, AF_PLAIN, 38}, {AT_CLAW, AF_PLAIN, 18}, {AT_CLAW, AF_PLAIN, 18},
       AT_NO_ATK },
    14, 1070,
    10, 8, MST_BEAR, true, S_GROWL,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_BIG, MON_SHAPE_QUADRUPED_TAILLESS,
    {TILEP_MONS_ANCIENT_BEAR}, TILE_CORPSE_ANCIENT_BEAR
},
...

{
    ...
    18, 1470,
    4, 15, MST_NO_SPELLS, true, S_SILENT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
...
{ // more single vault dummies...
    MONS_HANSEL, 'p', LIGHTGREY, "Hansel",
    M_UNIQUE | M_MALE | M_WARM_BLOOD,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 20,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 330,
...
{ // more single vault dummies...
    MONS_GRETEL, 'p', LIGHTGREY, "Gretel",
    M_UNIQUE | M_FEMALE | M_WARM_BLOOD,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 20,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 330,
...
DUMMY(MONS_INSUBSTANTIAL_WISP, 'v', LIGHTGREY, "insubstantial wisp",
      TILEP_MONS_PROGRAM_BUG) // TODO: get proper tile for will-o-the-wisp
...
{
    MONS_FAERIE_DRAGON, 'D', LIGHTMAGENTA, "faerie dragon",
    M_WARM_BLOOD | M_FLIES,
    MR_NO_FLAGS,
    12, MONS_DRAGON, MONS_FAERIE_DRAGON, MH_NATURAL, 140,
    { {AT_BITE, AF_PLAIN, 20}, {AT_CLAW, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK },
    5, 580,
    5, 18, MST_FAERIE_DRAGON, true, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    { { AT_KICK, AF_PLAIN, 25 }, { AT_KICK, AF_PLAIN, 25 }, AT_NO_ATK, AT_NO_ATK },
    18, 666,
    5, 15, MST_GREENWOOD_WITCH, true, S_SHOUT,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 800,
    2, 10, MST_ELEIONOMA, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    7, 385,
    0, 17, MST_NO_SPELLS, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_DWARVEN_AUTOMATON, '8', LIGHTGREY, "dwarven automaton",
    M_NO_FLAGS,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC | MR_RES_ACID, 3),
    10, MONS_GOLEM, MONS_DWARVEN_AUTOMATON, MH_NONLIVING, MAG_IMMUNE,
    { {AT_TRAMPLE, AF_TRAMPLE, 20}, {AT_TRAMPLE, AF_TRAMPLE, 20}, 
      {AT_TRAMPLE, AF_TRAMPLE, 20}, {AT_TRAMPLE, AF_TRAMPLE, 20} },
    15, 1350,
    12, 10, MST_DWARVEN_AUTOMATON, false, S_SILENT,
    I_BRAINLESS, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_BIG, MON_SHAPE_HUMANOID,
    {TILEP_MONS_DWARVEN_AUTOMATON}, TILE_ERROR
},
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    mrd(MR_RES_ACID, 3),
    18, MONS_DWARF, MONS_SLUDGE_DWARF, MH_NATURAL, 120,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 1200,
