...
{ SP_BARACHI, {
    ...
    { { MUT_HOP, 1, 1 }, { MUT_SLOW, 1, 1 }, { MUT_HOP, 1, 13 } },
    { "You can be seen from farther away. (+LOS)", "You can swim through water." },
    { "+LOS", "swims" },
...
{ SP_DEMIGOD, {
    ...
    {},
    {},
    { JOB_TRANSMUTER, JOB_CONJURER, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_AIR_ELEMENTALIST, JOB_EARTH_ELEMENTALIST },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_SLINGS, SK_BOWS, SK_CROSSBOWS },
    nullptr,
    nullptr,
} },
...
{ SP_DEMONSPAWN, {
    ...
    {},
    {},
    { JOB_GLADIATOR, JOB_BERSERKER, JOB_ABYSSAL_KNIGHT, JOB_WIZARD, JOB_NECROMANCER, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_SLINGS, SK_BOWS, SK_CROSSBOWS },
    nullptr,
    nullptr,
} },
...
{ SP_BASE_DRACONIAN, {
    ...
    {},
    {},
    { JOB_BERSERKER, JOB_TRANSMUTER, JOB_CONJURER, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_AIR_ELEMENTALIST, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_SLINGS, SK_BOWS, SK_CROSSBOWS },
    nullptr,
    nullptr,
} },
...
{ SP_WHITE_DRACONIAN, {
    ...
    { "You can breathe waves of freezing cold.", "You can buffet flying creatures when you breathe cold." },
    { "breathe frost" },
    {  },
    {  },
    nullptr,
...
{ SP_FAIRY, {
    ...
    { "Your spells' MP costs are reduced by 1.", "Your bright wings attract enemies. (Stealth-)", "You cannot fit into any form of body armour." },
    { "magic attunement", "unstealthy", "unfitting armour" },
    { JOB_WIZARD, JOB_CONJURER, JOB_NECROMANCER, JOB_ICE_ELEMENTALIST, JOB_FIRE_ELEMENTALIST, JOB_AIR_ELEMENTALIST, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_SLINGS, SK_BOWS, SK_CROSSBOWS },
    nullptr,
    nullptr,
} },
...
{ SP_FELID, {
    ...
    4, 9, 11,
    { STAT_INT, STAT_DEX }, 5,
    { { MUT_ACUTE_VISION, 1, 1 }, { MUT_CLAWS, 1, 1 }, { MUT_FANGS, 3, 1 }, { MUT_FAST, 1, 1 }, { MUT_PAWS, 1, 1 }, { MUT_SHAGGY_FUR, 1, 1 }, { MUT_SLOW_METABOLISM, 1, 1 }, { MUT_SHAGGY_FUR, 1, 6 }, { MUT_SHAGGY_FUR, 1, 12 } },
    { "You cannot wear almost all types of armour.", "You are incapable of wielding weapons or throwing items.", "Your paws allow you to move quietly. (Stealth)" },
    { "no armour", "no weapons or thrown items", "stealth" },
    { JOB_BERSERKER, JOB_ENCHANTER, JOB_TRANSMUTER, JOB_ICE_ELEMENTALIST, JOB_AIR_ELEMENTALIST, JOB_CONJURER, JOB_SUMMONER, JOB_VENOM_MAGE },
    { SK_UNARMED_COMBAT },
    nullptr,
    "sit before",
} },
...
{ SP_FORMICID, {
    ...
    { STAT_STR, STAT_INT }, 4,
    { { MUT_ANTENNAE, 3, 1 } },
    { "You cannot be hasted, slowed, berserked, paralysed or teleported.", "You can dig through walls and to a lower floor.", "Your four strong arms can wield two-handed weapons with a shield." },
    { "permanent stasis", "dig shafts and tunnels", "four strong arms" },
    { JOB_FIGHTER, JOB_HUNTER, JOB_ABYSSAL_KNIGHT, JOB_ARCANE_MARKSMAN, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_STAVES, SK_CROSSBOWS, SK_SLINGS },
    nullptr,
    nullptr,
} },
...
{ SP_GARGOYLE, {
    ...
    11, 8, 5,
    { STAT_STR, STAT_INT }, 4,
    { { MUT_NEGATIVE_ENERGY_RESISTANCE, 1, 1 }, { MUT_PETRIFICATION_RESISTANCE, 1, 1 }, { MUT_ROT_IMMUNITY, 1, 1 }, { MUT_SHOCK_RESISTANCE, 1, 1 }, { MUT_UNBREATHING, 1, 1 }, { MUT_BIG_WINGS, 1, 14 } },
    { "You are resistant to torment." },
    {},
    { JOB_FIGHTER, JOB_GLADIATOR, JOB_MONK, JOB_BERSERKER, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
...
{ SP_GHOUL, {
    ...
    11, 3, 4,
    { STAT_STR }, 5,
    { { MUT_CARNIVOROUS, 1, 1 }, { MUT_CLAWS, 1, 1 }, { MUT_COLD_RESISTANCE, 1, 1 }, { MUT_INHIBITED_REGENERATION, 1, 1 }, { MUT_NEGATIVE_ENERGY_RESISTANCE, 3, 1 }, { MUT_TORMENT_RESISTANCE, 1, 1 }, { MUT_UNBREATHING, 1, 1 } },
    { "Your body is rotting away.", "You gain health and satiation by devouring corpses." },
    { "rotting body" },
...
{ SP_GNOLL, {
    ...
    10, 10, 10,
    { STAT_STR, STAT_INT, STAT_DEX }, 4,
    { { MUT_FANGS, 1, 1 }, { MUT_STRONG_NOSE, 1, 1 } },
    { "Your experience applies equally to all skills." },
    { "distributed training" },
    { JOB_SKALD, JOB_WARPER, JOB_ARCANE_MARKSMAN, JOB_TRANSMUTER, JOB_WANDERER },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_SLINGS, SK_BOWS, SK_CROSSBOWS },
    nullptr,
    nullptr,
} },
...
{ SP_HUMAN, {
    ...
    {},
    {},
    { JOB_BERSERKER, JOB_CONJURER, JOB_NECROMANCER, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_SLINGS, SK_BOWS, SK_CROSSBOWS },
    nullptr,
    nullptr,
} },
...
{ SP_KOBOLD, {
    ...
    { { MUT_FANGS, 3, 1 } },
    { "You sometimes cause those who miss you in melee to attack themselves." },
    { "redirection" },
    { JOB_GLADIATOR, JOB_BERSERKER, JOB_ENCHANTER, JOB_NECROMANCER, JOB_VENOM_MAGE },
...
{ SP_MERFOLK, {
    ...
    { STAT_STR, STAT_INT, STAT_DEX }, 5,
    {},
    { "You revert to your normal form in water.", "You are very nimble and swift while swimming.", "You are very stealthy in the water. (Stealth+)" },
    { "change form in water", "swift swim", "stealthy swim" },
    { JOB_GLADIATOR, JOB_BERSERKER, JOB_SKALD, JOB_TRANSMUTER, JOB_SUMMONER, JOB_ICE_ELEMENTALIST, JOB_VENOM_MAGE },
...
{ SP_MINOTAUR, {
    ...
    { JOB_FIGHTER, JOB_GLADIATOR, JOB_MONK, JOB_HUNTER, JOB_BERSERKER, JOB_ABYSSAL_KNIGHT },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_SLINGS, SK_BOWS, SK_CROSSBOWS },
    nullptr,
    nullptr,
} },
...
{ SP_NAGA, {
    ...
    10, 8, 6,
    { STAT_STR, STAT_INT, STAT_DEX }, 4,
    { { MUT_ACUTE_VISION, 1, 1 }, { MUT_DEFORMED, 1, 1 }, { MUT_POISON_RESISTANCE, 1, 1 }, { MUT_SLOW, 2, 1 }, { MUT_SLOW_METABOLISM, 1, 1 }, { MUT_SPIT_POISON, 1, 1 }, { MUT_CONSTRICTING_TAIL, 1, 13 } },
    { "You cannot wear boots." },
    {},
    { JOB_BERSERKER, JOB_TRANSMUTER, JOB_ENCHANTER, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_WARPER, JOB_WIZARD, JOB_VENOM_MAGE },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_SLINGS, SK_BOWS, SK_CROSSBOWS },
    "Slid",
    "coil in front of",
} },
...
{ SP_OCTOPODE, {
    ...
    { "You cannot wear most types of armour.", "You are very stealthy in the water. (Stealth+)" },
    { "almost no armour", "stealthy swim" },
    { JOB_TRANSMUTER, JOB_WIZARD, JOB_CONJURER, JOB_ASSASSIN, JOB_FIRE_ELEMENTALIST, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_SLINGS, SK_BOWS, SK_CROSSBOWS },
    "Wriggl",
    "curl up in front of",
} },
...
{ SP_OGRE, {
    ...
    {},
    {},
    { JOB_HUNTER, JOB_BERSERKER, JOB_ARCANE_MARKSMAN, JOB_WIZARD, JOB_FIRE_ELEMENTALIST },
...
{ SP_SPRIGGAN, {
    ...
    4, 9, 11,
    { STAT_INT, STAT_DEX }, 5,
    { { MUT_ACUTE_VISION, 1, 1 }, { MUT_FAST, 3, 1 }, { MUT_HERBIVOROUS, 1, 1 }, { MUT_SLOW_METABOLISM, 2, 1 } },
    {},
    {},
    { JOB_ASSASSIN, JOB_ARTIFICER, JOB_ABYSSAL_KNIGHT, JOB_WARPER, JOB_ENCHANTER, JOB_CONJURER, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
...
{ SP_TENGU, {
    ...
    8, 8, 9,
    { STAT_STR, STAT_INT, STAT_DEX }, 4,
    { { MUT_BEAK, 1, 1 }, { MUT_TALONS, 3, 1 }, { MUT_TENGU_FLIGHT, 1, 5 } },
    {},
    {},
    { JOB_BERSERKER, JOB_WIZARD, JOB_CONJURER, JOB_SUMMONER, JOB_FIRE_ELEMENTALIST, JOB_AIR_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_STAVES, SK_BOWS, SK_CROSSBOWS },
    "Glid",
    nullptr,
} },
...
{ SP_TROLL, {
    ...
    15, 4, 5,
    { STAT_STR }, 3,
    { { MUT_CLAWS, 3, 1 }, { MUT_FAST_METABOLISM, 3, 1 }, { MUT_REGENERATION, 1, 1 }, { MUT_SHAGGY_FUR, 1, 1 }, { MUT_TOUGH_SKIN, 3, 1 } },
    { "You gain satiation by eating corpses." },
    {},
    { JOB_FIGHTER, JOB_MONK, JOB_HUNTER, JOB_BERSERKER, JOB_WARPER, JOB_EARTH_ELEMENTALIST, JOB_WIZARD },
...
{ SP_VAMPIRE, {
    ...
    7, 10, 9,
    { STAT_INT, STAT_DEX }, 5,
    { { MUT_ACUTE_VISION, 1, 1 }, { MUT_COLD_RESISTANCE, 1, 1 }, { MUT_ENHANCED_BY_DEATH, 1, 1 }, { MUT_FANGS, 3, 1 }, { MUT_NEGATIVE_ENERGY_RESISTANCE, 3, 1 }, { MUT_NO_REGENERATION, 1, 1 }, { MUT_POWERED_BY_DEATH, 1, 1 }, { MUT_STEALTHY_ARMOUR, 1, 1 }, { MUT_TORMENT_RESISTANCE, 1, 1 }, { MUT_UNBREATHING, 1, 1 }, { MUT_ENHANCED_BY_DEATH, 1, 11 }, { MUT_POWERED_BY_DEATH, 1, 11 }, { MUT_ENHANCED_BY_DEATH, 1, 22 }, { MUT_POWERED_BY_DEATH, 1, 22 } },
    { "You do not eat.", "You are resistant to damage.", "You can heal yourself by drinking your own blood.", "You are exceptionally light of foot. (Stealth+)" },
    { "no food", "damage resistance", "heal wounds", "stealth" },
    { JOB_GLADIATOR, JOB_ASSASSIN, JOB_ENCHANTER, JOB_NECROMANCER, JOB_EARTH_ELEMENTALIST, JOB_ICE_ELEMENTALIST },
...
{ SP_VINE_STALKER, {
    ...
    10, 8, 9,
    { STAT_STR, STAT_DEX }, 4,
    { { MUT_ANTIMAGIC_BITE, 1, 1 }, { MUT_FANGS, 2, 1 }, { MUT_MANA_SHIELD, 1, 1 }, { MUT_NO_POTION_HEAL, 3, 1 }, { MUT_ROT_IMMUNITY, 1, 1 }, { MUT_REGENERATION, 1, 4 }, { MUT_FANGS, 1, 8 }, { MUT_REGENERATION, 1, 12 } },
    {},
    {},
    { JOB_FIGHTER, JOB_ASSASSIN, JOB_BERSERKER, JOB_ENCHANTER, JOB_CONJURER, JOB_NECROMANCER, JOB_ICE_ELEMENTALIST },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_STAVES, SK_BOWS, SK_CROSSBOWS },
    "Stalk",
    nullptr,
} },
